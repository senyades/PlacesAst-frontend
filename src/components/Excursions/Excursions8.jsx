  ...
  return (
    <div className="tour-page">
      ...
      <div className="viewer-container">
        <iframe width="100%" height="640" frameborder="0" allow="xr-spatial-tracking; gyroscope; accelerometer" allowfullscreen scrolling="no" src="https://kuula.co/share/hHHnn?logo=1&info=1&fs=1&vr=0&sd=1&thumbs=1"></iframe>
      </div>
